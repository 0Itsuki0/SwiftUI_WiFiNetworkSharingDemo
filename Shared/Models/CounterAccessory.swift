...
class CounterAccessory {
    ...
    static let networkSharingCharacteristicUUID: CBUUID = CBUUID(string: "D5E4C88B-59EB-4E4B-B751-CF5092C6E99C")
    
    static let networkSharingCharacteristic = CBMutableCharacteristic(
        type: networkSharingCharacteristicUUID,
        properties: [.write, .writeWithoutResponse],
        value: nil,
        permissions: [.writeable]
    )
    
    static let networkRequestCharacteristicUUID: CBUUID = CBUUID(string: "6690CE7A-0E2D-4933-B51A-D09A115CB957")
    
    static let networkRequestCharacteristic = CBMutableCharacteristic(
        type: networkRequestCharacteristicUUID,
    ...
    static let name: String = "Itsuki's Accessory"
    ...
    static var service: CBMutableService {
        ...
        service.characteristics = [counterCharacteristic, networkSharingCharacteristic, networkRequestCharacteristic]
